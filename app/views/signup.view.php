...
<body id="page-content">
    ...
    <div class="auth-container">
        <div class="auth-form">
                ...
                <script>
                    ...
                    form.addEventListener('submit', (e)=>{
                        ...
                        if (!nameRegex.test(fname) || !nameRegex.test(lname)) {
                            e.preventDefault();
                            alert("Names should be only Alphabets with spaces!");
                        }else{
                            submitButton.classList.add('loading');
                            setTimeout(() => {
                                submitButton.classList.remove('loading');
                                submitButton.classList.add('success');
                                // You can also change button text or style here
                            }, 4000);
                        }
                    })
            ...
            <p><small>Already have an account? <a href="<?= ROOT_URL ?>/signin">Login</a></small></p>
        </div>
    </div>
